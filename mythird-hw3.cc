...
main(int argc, char* argv[])
{
    ...
    ServerOss << "/NodeList/" << wifiStaNodes.Get(nWifi - 2)->GetId() << "/$ns3::MobilityModel/CourseChange";
    ClientOss << "/NodeList/" << wifiStaNodes.Get(nWifi - 1)->GetId() << "/$ns3::MobilityModel/CourseChange";
